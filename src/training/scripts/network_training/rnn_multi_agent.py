"""Training of the agent using the rnn network"""
...
if __name__ == "__main__":
    ...
    task_pricing_agents = [
        TaskPricingDqnAgent(agent_num, create_rnn_dqn_network(9, 21), save_folder=save_folder)
        for agent_num in range(3)
    ]
    resource_weighting_agents = [
        ResourceWeightingDqnAgent(0, create_rnn_dqn_network(16, 11), save_folder=save_folder)
    ]
