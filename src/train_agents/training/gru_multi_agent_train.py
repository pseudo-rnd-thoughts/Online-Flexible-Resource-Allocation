...
if __name__ == "__main__":
    ...
    task_pricing_ddqn_agents = [
        TaskPricingDqnAgent(agent_num, DqnGruNetwork(agent_num, 9, 10), save_frequency=25000, save_folder=folder,
    ...
    resource_weighting_ddqn_agents = [
        ResourceWeightingDqnAgent(agent_num, DqnGruNetwork(agent_num, 10, 10), save_frequency=25000,
