...
if __name__ == "__main__":
    folder = 'bidirectional_multi_agents'
    ...
    task_pricing_ddqn_agents = [
        TaskPricingDqnAgent(agent_num, DqnBidirectionalLstmNetwork(agent_num, 9, 10), save_frequency=25000, save_folder=folder,
    ...
    resource_weighting_ddqn_agents = [
        ResourceWeightingDqnAgent(agent_num, DqnBidirectionalLstmNetwork(agent_num, 10, 10), save_frequency=25000,
