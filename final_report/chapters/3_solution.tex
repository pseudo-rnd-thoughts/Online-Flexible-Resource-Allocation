...
\begin{longtable}{|p{5cm}|p{10cm}|} \hline
    ...
    Double Dueling DQN~\citep{doubledqn, duelingdqn} & A combination of two heuristics for the DQN agent that modify
        the loss function and modify the networks to separate the state's value and the action advantage. \\ \hline
...
%% TODO Possible add Seq2Seq network
