...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/task_pricing_network_architecture.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/resource_weighting_network_architecture.png}
