...
%% UNABLE TO COMPARE TO OLD SOLUTION EITHER FLEXIBLE RESOURCE ALLOCATION OR NORMAL SOLUTIONS
...
\begin{figure}[H]
    ...
    \caption{Environment and Agent numbers - Total prices}
...
\begin{figure}[H]
    ...
    \caption{Environment and Agent numbers - Total winning prices}
...
\begin{figure}[H]
    ...
    \caption{Network Architecture - Total prices}
...
\begin{figure}[H]
    ...
    \caption{Network Architecture - Total winning prices}
