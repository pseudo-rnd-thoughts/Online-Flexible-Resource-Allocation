...
\begin{figure}[H]
    ...
    \begin{minipage}{0.75\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/4_test_eval_figs/env_training_fig/single_env_num_completed_tasks.png}
        \caption{Number of completed tasks for Single environment setting}
        \label{fig:single_env_num_completed_tasks}
    \end{minipage}\hfill
    \begin{minipage}{0.25\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/4_test_eval_figs/env_training_fig/single_env_legend.png}
